...
{
  internal class BillsToReceiveConfiguration: EntityTypeConfiguration<BillsToReceive>
  {
    public BillsToReceiveConfiguration(string schema)
    {
      ToTable("BillsToReceive", schema);
